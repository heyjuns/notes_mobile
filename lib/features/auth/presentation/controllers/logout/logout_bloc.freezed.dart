...
class _Loaded implements LogoutState {
  const _Loaded();
...
class _Failed implements LogoutState {
...
@override
String toString() {
  return 'LogoutState.failed(error: $error)';
}
...
/// @nodoc
abstract mixin class _$FailedCopyWith<$Res> implements $LogoutStateCopyWith<$Res> {
